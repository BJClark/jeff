...
- **New to discovery?** Read `skills/map/references/methodology.md` and `skills/opportunity/references/methodology.md`.
- **Picking an experiment?** `skills/opportunity/references/experiment-methods.md`.
- **Writing good acceptance criteria?** `skills/bdd/references/acceptance-criteria.md`.
- **Setting up GitHub?** `skills/issues/references/gh-cli-setup.md`.
