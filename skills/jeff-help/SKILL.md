...
- `skills/jeff-map/` — story mapping with Patton's methodology.
- `skills/jeff-opportunity/` — OST with experiment method comparisons.
- `skills/jeff-hypothesis/` — hypothesis formula, validation methods.
- `skills/jeff-research/` — interview protocol, insight formula.
- `skills/jeff-bdd/` — acceptance criteria quality rules.
- `skills/jeff-issues/` — GitHub issue template and gh CLI setup.
