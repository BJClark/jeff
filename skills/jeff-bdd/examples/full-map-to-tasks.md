...
**Context:** `.jeff/STORY_MAP.md` has a populated backbone, walking skeleton, and Release 1 ribs (see jeff-map's `examples/` for the underlying content). `.jeff/OPPORTUNITIES.md` exists with opportunities O1–O3. `.jeff/TASKS.md` is template-only.
