...
Either `/jeff:init` didn't finish or the file was deleted. Offer to recreate it from the template rather than proceeding against a missing file. The template lives at `skills/init/templates/STORY_MAP.md`.
